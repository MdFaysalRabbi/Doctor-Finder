...
@section('content')
    <h3 class="text-center mb-5 mt-5">Patient Information</h3>
        ...
        <form action="{{route('tenant.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="col-md-6">
                    ...
                    <input type="text" required class="form-control" placeholder="Patient Name" name="name">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="balcony" placeholder="Enter your age"  required>
